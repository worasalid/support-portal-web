...
import IssueCreate from "./Page/Customer/Issue/IssueCreate";
import ServiceDesk from "./Page/Customer/ServiceDesk";
    ...
    return (
        <Router>
            <Switch>
                ...
                <Route path = "/customer/issue/create" exact component={IssueCreate} />
